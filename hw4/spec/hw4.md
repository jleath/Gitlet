...
Credits: RingBuffer figures from [wikipedia](http://en.wikipedia.org/wiki/Circular_buffer). This assignment adapted from [Kevin Wayne's Guitar Hero](http://nifty.stanford.edu/2012/wayne-guitar-heroine/) assignment.
