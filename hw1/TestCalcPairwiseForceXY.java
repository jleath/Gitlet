...
public class TestCalcPairwiseForceXY {
    ...
    private static void checkCalcPairwiseForceXY() {
        ...
        checkEquals(p1.calcPairwiseForceX(p2), 133.4, "calcPairwiseForceX()");
        checkEquals(p1.calcPairwiseForceX(p3), 4.002e-11, "calcPairwiseForceX()");
        checkEquals(p1.calcPairwiseForceY(p2), 0.0, "calcPairwiseForceY()");
        checkEquals(p1.calcPairwiseForceY(p3), 5.336e-11, "calcPairwiseForceY()");
    }
}