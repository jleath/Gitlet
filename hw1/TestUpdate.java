...
public class TestUpdate {
    ...
    private static void checkUpdate() {
        ...
        checkEquals(p1.x, 7.0, "update()");
        checkEquals(p1.y, 9.0, "update()");
        checkEquals(p1.xAccel, 0.0, "update()");
        checkEquals(p1.yAccel, 0.0, "update()");
        checkEquals(p1.xVelocity, 3.0, "update()");
        checkEquals(p1.yVelocity, 4.0, "update()");
    }
}